...
const data = (req, res) => {
  const data = {
    ...
    'data': mockjs.mock({
      ...
      "subQuestionTemplateHtml": "[{\"idx\":0,\"title\":\"序号\",\"html\":\"<p>sssss</p>\",\"subQuestionType\":\"1\"},{\"idx\":1,\"title\":\"问题\",\"html\":\"<p>ssssss</p>\",\"subQuestionType\":\"3\"}]",
...
export default {
  'GET /api/template/formQuestionTemplate/get/:formQuestionTemplateId': data
};
