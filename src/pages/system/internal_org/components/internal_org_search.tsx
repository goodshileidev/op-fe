...
interface IInternalOrgSearchProps {
  onReloadTable: any,
...
const InternalOrgSearch: React.FC<IInternalOrgSearchProps> = ((props) => {
  ...
  return (
    ...
    <Card title={t("common.title.search",{'entity':t('system.internal_org')})}  bordered={true}>
      <Form
        form={searchForm}
        layout="vertical"
...
<Col className="gutter-row" span={12}>
    <Form.Item name="orgNoCondition" label={t("system.internal_org.org_no")}   style={{maxWidth:500}}>
        <Input placeholder={t("system.internal_org.org_no")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={12}>
    <Form.Item name="orgNameCondition" label={t("system.internal_org.org_name")}   style={{maxWidth:500}}>
        <Input placeholder={t("system.internal_org.org_name")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={12}>
    <Form.Item name="orgTypeCondition" label={t("system.internal_org.org_type")}  style={{maxWidth:500}}>
     <Select
        options={
            codeList.OrgType
          }
...
export default InternalOrgSearch;
