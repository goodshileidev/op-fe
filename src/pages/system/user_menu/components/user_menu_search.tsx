...
interface IUserMenuSearchProps {
  onReloadTable: any,
...
const UserMenuSearch: React.FC<IUserMenuSearchProps> = ((props) => {
...
//      borderRadius: token.borderRadiusLG,
  ...
  return (
    ...
    <Card title={t("common.title.search",{'entity':t('system.user_menu')})} bordered={true}>
      <Form
