...
import {getUserMenu, updateUserMenu, createUserMenu} from "@/common/service/system/user_menu";
...
const UserMenuEdit: React.FC<IUserMenuEditProps> = ((props) => {
  ...
  //   return (
  //     <Card title={isEdit?t("common.title.edit",{'entity':t('system.user_menu')}):t("common.title.add",{'entity':t('system.user_menu')})} bordered={true}>
  //       <Alert
