...
import DocumentTemplateVersionEdit from './components/document_template_version_edit'

const DocumentTemplateVersionEditPage: React.FC = (() => {
  ...
  return (
   <>
    <Card title={isEdit ? t("common.title.edit",{'entity':t('template.document_template_version')}) : t("common.title.add",{'entity':t('template.document_template_version')})} bordered={false} style={{width: "80%"}}>
        <DocumentTemplateVersionEdit documentTemplateVersionId={documentTemplateVersionId} isOpen={true} onUpdate={handleUpdate} needReset={needReset} needSubmit={needSubmit}/>
      <Space>
...
export default DocumentTemplateVersionEditPage;
