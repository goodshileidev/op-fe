...
const ShipOperationDocumentEditPage: React.FC = (() => {
  ...
  return (
    <>
      <Card title={isEdit ? t("common.title.edit",{'entity':t('form.ship_operation_document')}) : t("common.title.add",{'entity':t('form.ship_operation_document')})} bordered={false} style={{width: "80%"}}>
