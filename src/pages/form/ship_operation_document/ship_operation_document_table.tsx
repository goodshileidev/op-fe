...
import {searchShipOperationDocument, deleteShipOperationDocument, updateShipOperationDocument } from '@/common/service/form/ship_operation_document'
...
const ShipOperationDocumentTablePage: React.FC = (() => {
  ...
  const handleAdd = (params: any) => {
    navigate("/form/ship_operation_document/ship_operation_document_edit_page/0", { replace: true });
  }
 ...
 const columns: TableProps<ShipOperationDocumentType>['columns'] = []
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.operation_plan_id"),
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.turn_group"),
      key: "turn_group",
      dataIndex: "turnGroup",
      ellipsis: true,
      width: "100px",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.turn_no"),
      key: "turn_no",
      dataIndex: "turnNo",
      ellipsis: true,
      width: "100px",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.ship_name"),
      key: "ship_name",
      dataIndex: "shipName",
      ellipsis: true,
      width: "100px",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.cargo_name"),
      key: "cargo_name",
      dataIndex: "cargoName",
      ellipsis: true,
      width: "100px",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.platform_cargo_name"),
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.domestic_foreign_trade_type"),
      ...
      render:(text:string, row:any, index: number ) => (
        <div>
         {codeList.DomesticForeignTradeType.filter((item) => (item.value===row.domesticForeignTradeType)).map((item) => (<span color="green" key={item.value}>{item.label}</span>))}
        </div>
 ),
       className:" text_center ",
    })
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.operation_type"),
      key: "operation_type",
      ...
      render:(text:string, row:any, index: number ) => (
        <div>
         {codeList.OperationType.filter((item) => (item.value===row.operationType)).map((item) => (<span color="green" key={item.value}>{item.label}</span>))}
        </div>
 ),
       className:" text_center ",
    })
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.port_name"),
      key: "port_name",
      dataIndex: "portName",
      ellipsis: true,
      width: "100px",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.voyage_no"),
      key: "voyage_no",
      dataIndex: "voyageNo",
      ellipsis: true,
      width: "100px",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.net_tonnage"),
      key: "net_tonnage",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.gross_tonnage"),
      key: "gross_tonnage",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.dead_weight_tonnage"),
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.load_unload"),
      key: "load_unload",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.english_ship_name"),
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.ship_mmsi"),
      key: "ship_mmsi",
      dataIndex: "shipMmsi",
      ellipsis: true,
      width: "100px",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.planed_arriving_time"),
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.berthing_time"),
      key: "berthing_time",
    ...
    columns.push({align: "center",
      title: t("form.ship_operation_document.departure_time"),
      key: "departure_time",
  ...
  columns.push({align: "center",
      ...
      render: (text: string, row: ShipOperationDocumentType, index: number) => (
        <div>
          <Link to={`/form/ship_operation_document/ship_operation_document_detail_page/${row.shipOperationDocumentId}`}>
            <Button size="small" type="link">{t("common.button.detail")}</Button>
          </Link>
          <Link to={`/form/ship_operation_document/ship_operation_document_edit_page/${row.shipOperationDocumentId}`}>
  ...
  return (
      <PageContainer>
        <ShipOperationDocumentSearch onAdd={handleAdd} onReloadTable={handleSearch} pagination={pagination} setCurrentConditions={setCurrentConditions}/>
        <Card title={t("common.title.list",{'entity':t('form.ship_operation_document')})}
          bordered={true}
          style={{
