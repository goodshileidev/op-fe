...
//      borderRadius: token.borderRadiusLG,
  ...
  return (
    ...
    <Card title={t("common.title.search",{'entity':t('form.ship_operation_document')})} bordered={true}>
      <Form
        style={{  }}
        size={'small'}
        form={searchForm}
...
<Col className="gutter-row" span={8}>
    <Form.Item name="operationPlanIdCondition" label={t("form.ship_operation_document.operation_plan_id")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.operation_plan_id")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="turnGroupCondition" label={t("form.ship_operation_document.turn_group")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.turn_group")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="turnNoCondition" label={t("form.ship_operation_document.turn_no")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.turn_no")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="domesticForeignTradeTypeCondition" label={t("form.ship_operation_document.domestic_foreign_trade_type")}  style={{maxWidth:500}}>
     <Select
        options={
            codeList.DomesticForeignTradeType
          }
        placeholder={t("form.ship_operation_document.domestic_foreign_trade_type")} >
     </Select>
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="bizTypeCondition" label={t("form.ship_operation_document.biz_type")}  style={{maxWidth:500}}>
     <Select
        options={
            codeList.BizType
          }
...
<Col className="gutter-row" span={8}>
    <Form.Item name="portNameCondition" label={t("form.ship_operation_document.port_name")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.port_name")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="voyageNoCondition" label={t("form.ship_operation_document.voyage_no")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.voyage_no")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="netTonnageCondition" label={t("form.ship_operation_document.net_tonnage")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.net_tonnage")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="grossTonnageCondition" label={t("form.ship_operation_document.gross_tonnage")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.gross_tonnage")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="deadWeightTonnageCondition" label={t("form.ship_operation_document.dead_weight_tonnage")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.dead_weight_tonnage")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="loadUnloadCondition" label={t("form.ship_operation_document.load_unload")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.load_unload")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="englishShipNameCondition" label={t("form.ship_operation_document.english_ship_name")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.english_ship_name")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={8}>
    <Form.Item name="shipMmsiCondition" label={t("form.ship_operation_document.ship_mmsi")}   style={{maxWidth:500}}>
        <Input placeholder={t("form.ship_operation_document.ship_mmsi")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={24}>
    <Form.Item name="planedArrivingTimeStartCondition" label={t("form.ship_operation_document.planed_arriving_time")}  style={{maxWidth:500}}>
        <DatePicker format="YYYY-MM-DD" placeholder={t("form.ship_operation_document.planed_arriving_time")}
        />
    </Form.Item>
...
<Col className="gutter-row" span={24}>
    <Form.Item name="berthingTimeStartCondition" label={t("form.ship_operation_document.berthing_time")}  style={{maxWidth:500}}>
        <DatePicker format="YYYY-MM-DD" placeholder={t("form.ship_operation_document.berthing_time")}
        />
    </Form.Item>
...
<Col className="gutter-row" span={24}>
    <Form.Item name="departureTimeStartCondition" label={t("form.ship_operation_document.departure_time")}  style={{maxWidth:500}}>
        <DatePicker format="YYYY-MM-DD" placeholder={t("form.ship_operation_document.departure_time")}
        />
    </Form.Item>
