...
import {getShipOperationDocument, updateShipOperationDocument, createShipOperationDocument} from "@/common/service/operation/ship_operation_document";
...
const ShipOperationDocumentEdit: React.FC<IShipOperationDocumentEditProps> = ((props) => {
    ...
    if (isEdit && shipOperationDocumentId && shipOperationDocumentId!=='0') {
      ...
      createShipOperationDocument(values).then((response: any) => {
        ...
        if (code === 200) {
          ...
          message.success(t("common.add_success",{'entity':t('operation.ship_operation_document')}));
          if (props.onUpdate){
            props.onUpdate(true, response.data)
          }
        } else {
  ...
  //   return (
  //     <Card title={isEdit?t("common.title.edit",{'entity':t('operation.ship_operation_document')}):t("common.title.add",{'entity':t('operation.ship_operation_document')})} bordered={true}>
  //       <Alert
  //         message={t("common.load_failed",{'entity':t('operation.ship_operation_document')})}
  //         description={t("common.load_failed_please_retry",{'entity':t('operation.ship_operation_document')})}
  //         type="error"
  //         showIcon
  //         action={
  //           <Button size="small" type="primary" onClick={() => history.push('/operation/ship_operation_document/ship_operation_document_table')}>
...
<Form.Item name="bizType" label={t("operation.ship_operation_document.biz_type")}
 ...
 <Select
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="portName" label={t("operation.ship_operation_document.port_name")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="voyageNo" label={t("operation.ship_operation_document.voyage_no")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="netTonnage" label={t("operation.ship_operation_document.net_tonnage")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="grossTonnage" label={t("operation.ship_operation_document.gross_tonnage")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="deadWeightTonnage" label={t("operation.ship_operation_document.dead_weight_tonnage")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="loadUnload" label={t("operation.ship_operation_document.load_unload")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="englishShipName" label={t("operation.ship_operation_document.english_ship_name")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="shipMmsi" label={t("operation.ship_operation_document.ship_mmsi")}
    ...
    items.push((
<Col className="gutter-row" span={12}>
<Form.Item name="dataDate" label={t("operation.ship_operation_document.data_date")}
    rules={ShipOperationDocumentRules.dataDate}
    >
    <Input placeholder={t("operation.ship_operation_document.data_date")} />
</Form.Item>
</Col>
    ))
  return items;
