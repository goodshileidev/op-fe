...
import {getShipOperationDocument} from '@/common/service/operation/ship_operation_document'
...
const ShipOperationDocumentDetail: React.FC<IShipOperationDocumentDetailProps> = ((props) => {
  ...
  const createBasicBasicItems = () => {
    ...
    items.push((
      {
        'key': 'turnGroup', 'label': t('operation.ship_operation_document.turn_group'), 'children': <p>
    ...
    items.push((
      {
        'key': 'turnNo', 'label': t('operation.ship_operation_document.turn_no'), 'children': <p>
    ...
    items.push((
      {
        'key': 'shipName', 'label': t('operation.ship_operation_document.ship_name'), 'children': <p>
    ...
    items.push((
      {
        'key': 'cargoName', 'label': t('operation.ship_operation_document.cargo_name'), 'children': <p>
    ...
    items.push((
      {
        'key': 'platformCargoName', 'label': t('operation.ship_operation_document.platform_cargo_name'), 'children': <p>
    ...
    items.push((
      {
        'key': 'bizType', 'label': t('operation.ship_operation_document.biz_type'), 'children': <p>
          {codeList.BizType
    ...
    items.push((
      {
        'key': 'operationType', 'label': t('operation.ship_operation_document.operation_type'), 'children': <p>
    ...
    items.push((
      {
        'key': 'portName', 'label': t('operation.ship_operation_document.port_name'), 'children': <p>
    ...
    items.push((
      {
        'key': 'voyageNo', 'label': t('operation.ship_operation_document.voyage_no'), 'children': <p>
    ...
    items.push((
      {
        'key': 'netTonnage', 'label': t('operation.ship_operation_document.net_tonnage'), 'children': <p>
    ...
    items.push((
      {
        'key': 'grossTonnage', 'label': t('operation.ship_operation_document.gross_tonnage'), 'children': <p>
    ...
    items.push((
      {
        'key': 'deadWeightTonnage', 'label': t('operation.ship_operation_document.dead_weight_tonnage'), 'children': <p>
    ...
    items.push((
      {
        'key': 'loadUnload', 'label': t('operation.ship_operation_document.load_unload'), 'children': <p>
    ...
    items.push((
      {
        'key': 'englishShipName', 'label': t('operation.ship_operation_document.english_ship_name'), 'children': <p>
    ...
    items.push((
      {
        'key': 'shipMmsi', 'label': t('operation.ship_operation_document.ship_mmsi'), 'children': <p>
    ...
    items.push((
      {
        'key': 'dataDate', 'label': t('operation.ship_operation_document.data_date'), 'children': <p>
    ...
    items.push((
      {
        'key': 'planedArrivingTime',
        'label': t('operation.ship_operation_document.planed_arriving_time'),
        'children': <p>
    ...
    items.push((
      {
        'key': 'berthingTime', 'label': t('operation.ship_operation_document.berthing_time'), 'children': <p>
    ...
    items.push((
      {
        'key': 'departureTime', 'label': t('operation.ship_operation_document.departure_time'), 'children': <p>
