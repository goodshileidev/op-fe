...
const NotificationConfigSearch: React.FC<INotificationConfigSearchProps> = ((props) => {
  ...
  return (
    ...
    <Card title={t("common.title.search",{'entity':t('notification.notification_config')})}  bordered={true}>
      <Form
        form={searchForm}
        layout="vertical"
...
<Col className="gutter-row" span={12}>
    <Form.Item name="documentNoCondition" label={t("notification.notification_config.document_no")}   style={{maxWidth:500}}>
        <Input placeholder={t("notification.notification_config.document_no")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={12}>
    <Form.Item name="notifiedPersonTypeCondition" label={t("notification.notification_config.notified_person_type")}  style={{maxWidth:500}}>
     <Select
        options={
...
<Col className="gutter-row" span={12}>
    <Form.Item name="notifiedPersonReceiptMethodCondition" label={t("notification.notification_config.notified_person_receipt_method")}  valuePropName="checked" style={{maxWidth:500}}>
      <Checkbox.Group
...
<Col className="gutter-row" span={12}>
    <Form.Item name="notificationDetailedContentTemplateCondition" label={t("notification.notification_config.notification_detailed_content_template")}   style={{maxWidth:500}}>
        <Input placeholder={t("notification.notification_config.notification_detailed_content_template")}
         />
    </Form.Item>
</Col>
<Col className="gutter-row" span={12}>
    <Form.Item name="isReceiptRecordRequiredCondition" label={t("notification.notification_config.is_receipt_record_required")}  valuePropName="checked"  style={{maxWidth:500}}>
      <Radio.Group
            options={
            codeList.YesNo
            }
...
<Col className="gutter-row" span={12}>
    <Form.Item name="receiptMethodCondition" label={t("notification.notification_config.receipt_method")}  valuePropName="checked" style={{maxWidth:500}}>
      <Checkbox.Group
