...
interface ITableColumnConfigFormEditorModalProps {
...
const TableColumnConfigTableEditorModal: React.FC<ITableColumnConfigFormEditorModalProps> = ((props) => {
  ...
  useEffect(() => {
    ...
    console.debug("TableColumnConfigList", tableColumnConfigList)
  }, []);
  ...
  const onUpdate = (value) => {
    setTableColumnConfigList(value[props.jsonFieldName])
  }
  ...
  return (
    <div>
      <Modal
        ...
        //   </Button>]}
      >
        <TableColumnConfigFormEditor onUpdate={onUpdate} fieldName={props.jsonFieldName}
