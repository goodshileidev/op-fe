...
const SubQuestionFormEditor: React.FC<ISubQuestionFormEditorProps> = ((props) => {
  ...
  const defaultFormVarConfigList = [
    ...
    {
      varName: "货量-全船数量",
      varKey: "cargoTotalWeight"
    },
    {
      varName: "货量-全船说明",
      varKey: "cargoTotalDescription"
    },
    {
      varName: "计划抵港时间",
  ...
  const defaultFormVarConfigList1 = [
    {
      varName: "船名",
      varKey: "shipName"
    },
  ...
  console.debug("SubQuestionFormEditor-formVarConfigList", props.formVarConfigList)
  console.debug("SubQuestionFormEditor-defaultFormVarConfigList", defaultFormVarConfigList)
  console.debug("SubQuestionFormEditor-questionVarConfigList", props.questionVarConfigList)
  const formVarConfigList = [...defaultFormVarConfigList, ...props.formVarConfigList]
  return (
    <div
      style={{
        height: 600,
