...
import NotificationHistorySearch from './notification_history_search'
 ...
 const columns: TableProps<NotificationHistoryType>['columns'] = []
  ...
  return (
      <div style={{
        ...
        <NotificationHistorySearch onAdd={handleAdd} onReloadTable={handleSearch} pagination={pagination}/>
