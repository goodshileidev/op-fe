...
import NotificationConfigSearch from './notification_config_search'
...
const NotificationConfigTable: React.FC = (() => {
  ...
  const fetchNotificationConfigList = async (params: any = {}) => {
    ...
    const { totalSize,pageNo,pageSize } = pageInfo
 ...
 const columns: TableProps<NotificationConfigType>['columns'] = []
  ...
  return (
      <div style={{
        ...
        <NotificationConfigSearch onAdd={handleAdd} onReloadTable={handleSearch} pagination={pagination}/>
        <Card title={t("common.title.list",{'entity':t('notification.notification_config')})}
          bordered={true}
          extra={[<Button onClick={()=>{
                setIsColumnsSelectVisible(true)
          ...
          <Spin spinning={loading}>
            <SuperTable
              ...
              setIsColumnsVisible={setIsColumnsSelectVisible}
              isColumnsSelectVisible={isColumnsSelectVisible}
        ...
        <NotificationConfigEdit
            isNotificationConfigEditModalVisible={isEditModalVisible}
            notificationConfigId={currentNotificationConfigId}
            onClose={handleEditModalClose}/>
        <NotificationConfigDetail
            isNotificationConfigDetailModalVisible={isDetailModalVisible}
            notificationConfigId={currentNotificationConfigId}
