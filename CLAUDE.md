# Claude 项目理解记录（长期记忆文档）

> 本文档提供项目的详细技术架构和业务领域知识，作为长期参考文档
>
> **快速开发指南请参阅**: [CLAUDES.md](./CLAUDES.md)
...
### 1. CLAUDES.md - 短期记忆文档（开发指南）

**定位**: Claude Code 专用的开发指南，聚焦于当前任务和开发流程
...
**参考**: [docs/README.md](./docs/README.md)
